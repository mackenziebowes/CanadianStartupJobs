...
const industry = {
  ...
  get_by_experienceLevel: get_jobsIndustries_by_industry,
}
...
const jobTypes = {
  ...
  get_by_jobCache: get_jobsJobTypes_by_jobType,
}
...
const provinces = {
  ...
  get_by_jobCache: get_jobsProvinces_by_province,
};
...
const roles = {
  ...
  get_by_jobCache: get_jobsRoles_by_role,
}
